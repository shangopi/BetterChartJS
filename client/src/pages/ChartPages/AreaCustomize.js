...
const Area_data = {
  ...
  datasets: [
    ...
    },
    {
      ...
      borderColor: "rgb(223, 122, 235)",
      backgroundColor: "rgba(223, 112, 235, 0.5)",
    },
  ],
};
...
const AreaChartView = () => {
  ...
  return (
    <Row>
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    ...
                    <Row>
                      <Col>
                        {" "}
                        <Form.Label>Axis Orientation </Form.Label>{" "}
                      </Col>
                      <Col>
                        <Form.Select
                          onChange={(e) => {
      ...
      <Col lg={8}>
        {" "}
        <AreaChart config={AreaCustomize} data={Area_data}></AreaChart>{" "}
      </Col>
    </Row>
  );
};
