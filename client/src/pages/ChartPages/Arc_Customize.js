  ...
  return (
    <div className="pr-5">
      <Row>
                  ...
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      ...
                      <Row>
                        <Col>
                          {" "}
                          <Form.Label> Adjust Graph Width </Form.Label>{" "}
                        </Col>
                        <Col>
                          <Form.Range
                            onChange={(e) => {
                      ...
                      <Row>
                        <Col>
                          {" "}
                          <Form.Label>Adjust Circle Size </Form.Label>{" "}
                        </Col>
                        <Col>
                          <Form.Range
                            onChange={(e) => {
                              set_circle_size(e.target.value);
                            }}
                            defaultValue={5}
                            min="2"
                            max="12"
                      ...
                      <Row>
                        <Col>
                          {" "}
                          <Form.Label>Adjust Arc Strength </Form.Label>{" "}
                        </Col>
                        <Col>
                          <Form.Range
                            onChange={(e) => {
                              set_arc_size(e.target.value);
                            }}
                            defaultValue={25}
                            min="10"
                            max="50"
                  ...
                  <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                      ...
                      <Row>
                        <Col>
                          {" "}
                          <Form.Label>Text Font Family </Form.Label>{" "}
                        </Col>
                        <Col>
                          <Form.Select
                            size="sm"
                      ...
                      <Row className="mt-2">
                        <Col>
                          {" "}
                          <Form.Label>Title Font Family </Form.Label>{" "}
                        </Col>
                        <Col>
                          <Form.Select
                            size="sm"
                            onChange={(e) => {
                              set_font2(e.target.value);
                            }}
                          >
                            <option value="Raleway">Raleway</option>
                            <option value="Roboto">Roboto</option>
        ...
        <Col lg={8}>
          <ArcChart config={Arc_customize} data={Arc_data} />{" "}
        </Col>
      </Row>
    </div>
  );
